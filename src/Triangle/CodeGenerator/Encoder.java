...
//  }
    ...
    public Object visitLoopWhileDoCommand(LoopWhileDoCommand ast, Object o) {
        ...
        patch(jumpAddr, nextInstrAddr);
        ast.E.visit(this, frame);
        emit(Machine.JUMPIFop, Machine.trueRep, Machine.CBr, loopAddr); // Si la expresi�n es verdadera, salta a loopAddr
        return null;
    }
    ...
    public Object visitLoopUntilDoCommand(LoopUntilDoCommand ast, Object o) {
        ...
        patch(jumpAddr, nextInstrAddr);
        ast.E.visit(this, frame);
        emit(Machine.JUMPIFop, Machine.falseRep, Machine.CBr, loopAddr); // Si la expresi�n es falsa, salta a loopAddr
        return null;
    }
